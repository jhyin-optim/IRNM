...
Yin, J., Li, Y., Jian, D., et al.: An inertial-relaxed Newton-type projection method for solving nonlinear equations with applications. Numerical Linear Algebra with Applications, 33, e70067 (2026)
